...
CREATE INDEX IF NOT EXISTS idx_document_tactic_suggestions_doc_id ON gh_document_tactic_suggestions(document_id);
CREATE INDEX IF NOT EXISTS idx_document_tactic_suggestions_confidence ON gh_document_tactic_suggestions(confidence DESC);
CREATE INDEX IF NOT EXISTS idx_document_tactic_suggestions_tactic_id ON gh_document_tactic_suggestions(tactic_id);
