-- ============================================================================
-- FEAT-GH-009-A: Create gh_programs table
-- ============================================================================
-- Purpose: Top-level course container for the Phase-Based Course Platform
-- Programs are the Netflix-style courses that learners enroll in
-- ============================================================================
...
-- Enrolled users can view their enrolled programs (handled at enrollment level)
-- This policy allows enrolled users to see programs even if not public
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'gh_programs' AND table_schema = 'public') THEN
    RAISE NOTICE '✓ FEAT-GH-009-A: gh_programs table created successfully';
  ELSE
    RAISE EXCEPTION '✗ FEAT-GH-009-A: gh_programs table creation FAILED';
  END IF;
END $$;
