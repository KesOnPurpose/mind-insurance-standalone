-- =====================================================================================
-- MIO Knowledge Chunks Table - WITH PGVECTOR EXTENSION CHECK
...
-- =====================================================================================
-- PRE-FLIGHT CHECK: Verify pgvector Extension is Available
-- =====================================================================================

DO $$
BEGIN
  -- Check if pgvector extension exists in available extensions
  IF NOT EXISTS (
...
╠════════════════════════════════════════════════════════════════════════════╣
║                                                                            ║
║  The pgvector extension is required for MIO semantic search but is not     ║
...
║  3. Search for "vector"                                                    ║
║  4. Click "Enable" to install pgvector                                     ║
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'vector') THEN
    RAISE EXCEPTION 'Failed to create vector extension. Please enable it manually in Supabase dashboard.';
  END IF;
