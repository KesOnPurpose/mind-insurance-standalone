  ...
  return (
    <SheetPrimitive.Overlay
      className={cn(
        ...
        // When tour is highlighting sidebar: raise z-index above tour overlay (z-[9998])
        // and make overlay transparent so tour's own overlay handles dimming
        isTourHighlightingSidebar ? "z-[9998] bg-transparent pointer-events-none" : "z-50 bg-black/80",
        className,
      )}
      {...props}
      ref={ref}
