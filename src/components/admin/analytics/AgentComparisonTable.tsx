    ...
    const data = [
      {
        ...
        conversations: netteQuery.data.total_conversations ?? 0,
        cacheHitRate: netteQuery.data.cache_hit_rate ?? 0,
        avgResponseTime: netteQuery.data.avg_response_time_ms ?? 0,
        description: 'Network & Exposure Therapy Tactical Engine',
      },
      {
        agent: 'MIO' as const,
        agentType: 'mio' as AgentType,
        conversations: mioQuery.data.total_conversations ?? 0,
        cacheHitRate: mioQuery.data.cache_hit_rate ?? 0,
        avgResponseTime: mioQuery.data.avg_response_time_ms ?? 0,
        description: 'Mind Insurance Oracle',
      },
      {
        agent: 'ME' as const,
        agentType: 'me' as AgentType,
        conversations: meQuery.data.total_conversations ?? 0,
        cacheHitRate: meQuery.data.cache_hit_rate ?? 0,
        avgResponseTime: meQuery.data.avg_response_time_ms ?? 0,
