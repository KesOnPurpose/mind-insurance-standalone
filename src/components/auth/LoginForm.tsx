...
export const LoginForm = () => {
  ...
  const { signIn, signInWithPassword, signInWithGoogle, signUp } = useAuth();
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      // Show a brief message about the redirect
      toast({
          ...
          <TabsContent value="signin" className="space-y-4">
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <Button
                ...
                disabled={isLoading}
              >
                {authMode === 'password' ? '✉️ Use Magic Link Instead' : '🔒 Use Password Instead'}
              </Button>
