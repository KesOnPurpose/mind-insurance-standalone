    ...
    <Card className="w-full max-w-md mx-auto bg-mi-navy-light border-mi-cyan/20">
      ...
      <CardContent>
        <Tabs defaultValue="signin" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-mi-navy">
            <TabsTrigger value="signin" className="data-[state=active]:bg-mi-cyan data-[state=active]:text-mi-navy">Sign In</TabsTrigger>
            <TabsTrigger value="signup" className="data-[state=active]:bg-mi-cyan data-[state=active]:text-mi-navy">Sign Up</TabsTrigger>
          </TabsList>
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 mi-input"
                    required
                    disabled={isLoading}
                  />
                  <Button
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="remember" className="text-sm font-normal cursor-pointer text-white/70">
                    Remember me for 30 days
                  </Label>
                </div>
                <Link
                  to="/forgot-password"
                  className="text-sm text-mi-cyan hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <div className="relative">
                <div className="absolute inset-0 flex items-center">
                  <span className="w-full border-t border-mi-cyan/20" />
                </div>
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-mi-navy-light px-2 text-white/50">Or continue with</span>
                </div>
              </div>
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full mi-btn-outline"
      ...
      <CardFooter>
        <p className="text-xs text-center text-white/50 w-full">
