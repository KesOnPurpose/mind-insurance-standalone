...
const IdentityCollisionAssessmentPage: React.FC = () => {
  ...
  // Handle continue after results - redirect to First Session experience
  const handleContinue = () => {
    // After assessment completion, always go to First Session to reveal protocol
    // The First Session will poll for the protocol generated by N8n webhook
    navigate('/mind-insurance/first-session', { replace: true });
  };
